        ...
        <form onSubmit={handleLogin} className="space-y-5">
          <div className="space-y-2">
            ...
            <Input 
              ...
              className="h-12 border-[#e8e7f5] focus:ring-[#2a7c7c] bg-[#f7f7fc] text-[#1e1c4a] rounded-xl"
              dir="ltr"
              required
            />
          </div>
          ...
          <Button 
            type="submit" 
            disabled={isLoading} 
            className="w-full h-14 bg-[#2a7c7c] hover:bg-[#236969] text-white font-bold text-lg rounded-xl mt-6 transition-all cursor-pointer"
          >
