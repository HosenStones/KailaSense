  ...
  return (
    <div>
      ...
      <div className="space-y-2">
        ...
        <div className="border-2 border-dashed border-[#e8e7f5] rounded-xl p-4 text-center cursor-pointer text-[#a8a6c4] text-sm font-semibold hover:bg-[#e4faf5] hover:border-[#2ecfaa] hover:text-[#2a7c7c] transition-colors">
